            ...
            try {
                ...
                setHeroSlides((prev)=>{
                    ...
                    if (Array.isArray(parsed) && parsed.length > 0) {
                        const newSlides = parsed.filter((slide)=>slide.url);
                ...
                const savedProductsJSON = localStorage.getItem(PRODUCTS_KEY);
                setProducts((prev)=>{
                    const allProducts = savedProductsJSON ? JSON.parse(savedProductsJSON) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"];
...
//# sourceMappingURL=src_0c45174d._.js.map