        ...
        async function fetchRecommendations() {
            try {
                ...
                if (result.recommendedProducts) {
                    const recommendedProds = result.recommendedProducts.map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].find((p)=>p.id === id)).filter((p)=>p !== undefined);
...
;
function Home() {
    const featuredProducts = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["products"].slice(0, 6);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6f4cb7cd._.js.map