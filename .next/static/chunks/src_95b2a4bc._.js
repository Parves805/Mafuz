...
function CategoryPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CategoryPage.useEffect": ()=>{
            const loadData = {
                "CategoryPage.useEffect.loadData": ()=>{
                    try {
                        ...
                        const newProducts = savedProductsJSON ? JSON.parse(savedProductsJSON) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"];
                        setProducts({
                            "CategoryPage.useEffect.loadData": (prev)=>JSON.stringify(prev) !== JSON.stringify(newProducts) ? newProducts : prev
                        }["CategoryPage.useEffect.loadData"]);
                        const savedCategoriesJSON = localStorage.getItem(CATEGORIES_KEY);
                        const newCategories = savedCategoriesJSON ? JSON.parse(savedCategoriesJSON) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialCategories"];
                        setCategories({
                            "CategoryPage.useEffect.loadData": (prev)=>JSON.stringify(prev) !== JSON.stringify(newCategories) ? newCategories : prev
                        }["CategoryPage.useEffect.loadData"]);
                    } catch (error) {
            ...
            const interval = setInterval(loadData, 2000);
            return ({
                "CategoryPage.useEffect": ()=>clearInterval(interval)
            })["CategoryPage.useEffect"];
        }
    }["CategoryPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
                        ...
                        children: [
                            ...
                            filteredProducts.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "No products found in this category yet."
                                }, void 0, false, {
                                    fileName: "[project]/src/app/category/[slug]/page.tsx",
                                    lineNumber: 123,
                                    columnNumber: 21
...
_s(CategoryPage, "zctNBkZBwqeo0lU3j388V+8aCzI=", false, function() {
    return [
...
//# sourceMappingURL=src_95b2a4bc._.js.map