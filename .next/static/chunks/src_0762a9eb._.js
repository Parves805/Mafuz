            ...
            try {
                ...
                if (savedProductsJSON) {
                    ...
                    if (Array.isArray(parsed)) {
                        ...
                        setAllProducts(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"]);
                    }
                } else {
                    setAllProducts(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"]);
                }
...
_s(ProductRecommendations, "o41jp1A8ICZdCPNGLjMXlBSGoG4=");
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                "useFirestoreQuery.useEffect.unsubscribe": (querySnapshot)=>{
                    const results = querySnapshot.docs.map({
                        "useFirestoreQuery.useEffect.unsubscribe.results": (doc)=>({
                                ...doc.data(),
                                id: doc.id
                            })
                    }["useFirestoreQuery.useEffect.unsubscribe.results"]);
                    setData(results);
                    setIsLoading(false);
                }
...
_s(useFirestoreQuery, "/iJyIuGohDU8HmiUawlNhy7FaxE=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
if (firebaseConfig.apiKey && firebaseConfig.authDomain && firebaseConfig.projectId) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        console.warn("[BazaarGo] Google Authentication and other Firebase features will be disabled.");
...
const createCollection = (collectionName)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(db, collectionName);
};
const productsCollection = createCollection('products');
const categoriesCollection = createCollection('categories');
const ordersCollection = createCollection('orders');
const reviewsCollection = createCollection('reviews');
const usersCollection = createCollection('users');
const chatThreadsCollection = createCollection('chatThreads');
const notificationsCollection = createCollection('notifications');
const settingsCollection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(db, 'settings');
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
        ...
        cards: [
            {
                id: '1',
                title: 'Classic Polo',
                imageUrl: 'https://fabrilife.com/products/650182af39a77-square.jpeg',
                link: '/category/polo-tshirt'
            },
            {
                id: '2',
                title: 'Designer Polo',
                imageUrl: 'https://img.drz.lazcdn.com/g/p/mdc/d08e501aee3431a41857876ab4646a5a.jpg_720x720q80.jpg',
                link: '/category/polo-tshirt'
            },
            {
                id: '3',
...
function Home() {
    ...
    const { data: settingsDocs, isLoading: settingsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$firestore$2d$query$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirestoreQuery"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["settingsCollection"]);
    ...
    const heroSlides = settings.website?.heroSlides || defaultSlides;
    const aiSettings = settings.ai || {
        recommendationsEnabled: true
    };
    const popupCampaign = settings.popup;
    const homepageSections = settings.homepageSections || defaultHomepageSections;
    const promoSections = settings.promoSections || defaultPromoSections;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            try {
                ...
                console.error("Failed to load viewing history from localStorage.", error);
            }
        }
    }["Home.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (popupCampaign?.enabled) {
...
_s(Home, "8xexwNNYzBNZtnOWhmagquixFmE=", false, function() {
    return [
...
//# sourceMappingURL=src_0762a9eb._.js.map