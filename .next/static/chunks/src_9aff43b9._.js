            ...
            const loadData = {
                "Home.useEffect.loadData": ()=>{
                    try {
                        ...
                        setHeroSlides({
                            "Home.useEffect.loadData": (prev)=>{
                                const parsed = savedImages ? JSON.parse(savedImages) : defaultSlides;
                                if (Array.isArray(parsed) && parsed.length > 0) {
                                    const newSlides = parsed.filter({
                                        "Home.useEffect.loadData.newSlides": (slide)=>slide.url
                                    }["Home.useEffect.loadData.newSlides"]);
                        ...
                        setProducts({
                            "Home.useEffect.loadData": (prev)=>{
                                const allProducts = savedProductsJSON ? JSON.parse(savedProductsJSON) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"];
                        ...
                        setAiSettings({
                            "Home.useEffect.loadData": (prev)=>{
                                const newSettings = savedAiSettings ? JSON.parse(savedAiSettings) : {
                                    recommendationsEnabled: true
                                };
...
_s(Home, "Zb23D7BrKW7S4PrFNYl4MCNN1/k=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_9aff43b9._.js.map